...
public class Lab2Fractions {
	   ...
	   */
	  public Lab2Fractions(int n, int d) {
	    if (n < 0) {
	   ...
	   *  @param n is the numerator.  Must be nonnegative.
	   */
	  public Lab2Fractions(int n) {
	    this(n, 1);
	  }

	  /** Constructs a Fraction 0/1. 
	   */
	  public Lab2Fractions() {
		  this(0, 1);
	   ...
	   */
	  public Lab2Fractions(Lab2Fractions original) {
	    numberOfFractions++;
	    numerator = 0;
	    denominator = 1;
	  }
	   ...
	   */
	  public Lab2Fractions add(Lab2Fractions f2) {
	    Lab2Fractions r = new Lab2Fractions((numerator * f2.denominator) +
	  ...
	  public static void main(String[] argv) {
	    ...
	    Lab2Fractions f0 = new Lab2Fractions();
	    Lab2Fractions f1 = new Lab2Fractions(3);
	    Lab2Fractions f2 = new Lab2Fractions(12, 20);
	    Lab2Fractions f3 = new Lab2Fractions(f2);
	   ...
	   Lab2Fractions sumOfTwo = f1.add(f2);
	    ...
	    System.out.println("\nTesting gcd:");
	    System.out.println("The gcd of 5 and 10 is: " + gcd(5, 10));
